...
/* harmony import */ var _modules_mobile_menu_mobile_menu__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/mobile-menu/mobile-menu */ "./js/modules/mobile-menu/mobile-menu.js");
/* harmony import */ var _modules_navigation_scroll_navigation_scroll__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/navigation-scroll/navigation-scroll */ "./js/modules/navigation-scroll/navigation-scroll.js");
/* harmony import */ var _modules_form_form_validity__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/form/form-validity */ "./js/modules/form/form-validity.js");
/* harmony import */ var _modules_form_form_storage__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/form/form-storage */ "./js/modules/form/form-storage.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_mobile_menu_mobile_menu__WEBPACK_IMPORTED_MODULE_2__["initMenu"])(); // Плавный скролл из шапки

  Object(_modules_navigation_scroll_navigation_scroll__WEBPACK_IMPORTED_MODULE_3__["onClickScroll"])();
  window.addEventListener('load', function () {
    Object(_modules_modals_init_modals__WEBPACK_IMPORTED_MODULE_1__["initModals"])(); // Валидация формы

    Object(_modules_form_form_validity__WEBPACK_IMPORTED_MODULE_4__["initFormValidate"])(); // Локальное хранилище

    Object(_modules_form_form_storage__WEBPACK_IMPORTED_MODULE_5__["initLocalStorage"])();
  });
});
...
/* harmony import */ var _form_validity__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./form-validity */ "./js/modules/form/form-validity.js");
...
var initLocalStorage = function initLocalStorage() {
  ...
  var storageName = '';
  var storageTel = '';
  var storageEmail = ''; // Проверяем работоспособность локального храналища в браузере
  ...
  if (storageName) {
    _form_validity__WEBPACK_IMPORTED_MODULE_0__["formNameInput"].value = storageName;
  } // Если в локальном хранилище есть номер телефона — автоматически вписываем его


  if (storageTel) {
    _form_validity__WEBPACK_IMPORTED_MODULE_0__["formTelInput"].value = storageTel;
  } // Если в локальном хранилище есть почта — автоматически вписываем его


  if (storageEmail) {
    _form_validity__WEBPACK_IMPORTED_MODULE_0__["formEmailInput"].value = storageEmail;
  } // Записываем введённые значения в локальное хранилище


  _form_validity__WEBPACK_IMPORTED_MODULE_0__["formBooking"].addEventListener('submit', function () {
    if (isStorageSupport && _form_validity__WEBPACK_IMPORTED_MODULE_0__["formNameInput"].value && _form_validity__WEBPACK_IMPORTED_MODULE_0__["formTelInput"].value && _form_validity__WEBPACK_IMPORTED_MODULE_0__["formEmailInput"].value) {
      localStorage.setItem('name', _form_validity__WEBPACK_IMPORTED_MODULE_0__["formNameInput"].value);
      localStorage.setItem('tel', _form_validity__WEBPACK_IMPORTED_MODULE_0__["formTelInput"].value);
      localStorage.setItem('email', _form_validity__WEBPACK_IMPORTED_MODULE_0__["formEmailInput"].value);
    }
  });
};
...
/*!******************************************!*\
  !*** ./js/modules/form/form-validity.js ***!
  \******************************************/
/*! exports provided: initFormValidate, formBooking, formNameInput, formTelInput, formEmailInput */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initFormValidate", function() { return initFormValidate; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formBooking", function() { return formBooking; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formNameInput", function() { return formNameInput; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formTelInput", function() { return formTelInput; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formEmailInput", function() { return formEmailInput; });
var formBooking = document.querySelector('[data-form]'); // Форма

var formNameInput = formBooking.querySelector('[data-form-name'); // Инпут имени

var formTelInput = formBooking.querySelector('[data-form-tel]'); // Инпут телефона

var formEmailInput = formBooking.querySelector('[data-form-email]'); // Инпут почты

var telPattern = /^([-+()0-9\s]+)$/; // Паттерн телефона
// Паттерн почты

var emailPattern = /^(([^<>()[\]\.,;:\s@\"]+(\.[^<>()[\]\.,;:\s@\"]+)*)|(\".+\"))@(([^<>()[\]\.,;:\s@\"]+\.)+[^<>()[\]\.,;:\s@\"]{2,})$/i; // Валидация формы

var initFormValidate = function initFormValidate() {
  // Тестим ввод имени
  formNameInput.addEventListener('input', function () {
    var nameValue = formNameInput.value; // Значение поля имени
  ...
  formTelInput.addEventListener('input', function () {
    var telValue = formTelInput.value; // Значение поля телефона
    // Проверяем паттерн
  ...
  formEmailInput.addEventListener('focusout', function () {
    var emailValue = formEmailInput.value; // Значение поля почты
...
var bodyModal = document.querySelector('[data-modal]'); // Тело страницы

var headerWrapper = document.querySelector('[data-wrapper]'); // Враппер

var navBlock = headerWrapper.querySelector('[data-menu]'); // Навбар

var navToggler = navBlock.querySelector('[data-toggler]'); // Кнопка меню

var navList = navBlock.querySelector('[data-list]'); // Список меню

var navLogo = navBlock.querySelector('[data-nav-logo]'); // Лого в меню

var mainLogo = headerWrapper.querySelector('[data-main-logo]'); // Главное лого
...
var initMenu = function initMenu() {
  ...
  navToggler.addEventListener('click', function () {
    var navBlockStatus = navBlock.getAttribute('data-menu'); // Получаем текущее состояние навбара
...
/*!***********************************************************!*\
  !*** ./js/modules/navigation-scroll/navigation-scroll.js ***!
  \***********************************************************/
/*! exports provided: onClickScroll */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onClickScroll", function() { return onClickScroll; });
/* harmony import */ var _mobile_menu_mobile_menu__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../mobile-menu/mobile-menu */ "./js/modules/mobile-menu/mobile-menu.js");

var anchorLinks = _mobile_menu_mobile_menu__WEBPACK_IMPORTED_MODULE_0__["navList"].querySelectorAll('a[href^="#"]'); // Все ссылки из списка в навигации шапки
// Плавный скролл

var onClickScroll = function onClickScroll() {
  anchorLinks.forEach(function (anchor) {
    ...
    if (anchor.getAttribute('href').substring(1) !== '') {
      anchor.addEventListener('click', function (evt) {
        evt.preventDefault(); // Делаем плавный скролл до кликнутого блока
